...
+ Chuyển đường dẫn tới một thư mục rỗng X đã được tạo thủ công từ trước.
    cd "E:\PYTHON\bt tu?n 5\assignment03"
...
+ Tạo một bản sao của file data.txt với tên newData.txt
    cp data.txt newData.txt
+ Tạo một bản sao của file data.txt với tên newData_2.txt
    cp data.txt newData_2.txt
